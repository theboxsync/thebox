...
feedbackRouter.route("/deletefeedback/:id").delete(authMiddleware, deleteFeedback);
feedbackRouter.route("/replyfeedback/:id").post(authMiddleware, replyFeedback);
feedbackRouter.route("/generate-feedback-token").post(authMiddleware, generateFeedbackToken);
